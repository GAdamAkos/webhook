...
app.post('/webhook', (req, res) => {
  ...
  try {
    // Meta webhook JSON struktúra alapján
    ...
    const from = message.from; // WhatsApp ID (pl. telefonszám)
    const messageBody = message.text?.body || ''; // üzenet szöveg
    const messageType = message.type || 'unknown';

    // Kontakt lekérdezése / beszúrása
